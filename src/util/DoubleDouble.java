 ...
 * <p>
 * A util.DoubleDouble uses a representation containing two double-precision values.
 ...
 * <p>
 * The API provides a value-oriented interface. util.DoubleDouble values are
 * immutable; operations on them return new objects carrying the result of the
 * operation. This provides a much simpler semantics for writing util.DoubleDouble
 ...
 * 
 */
public strictfp class DoubleDouble implements Serializable, Comparable,
		Cloneable {
	/**
	 ...
	 * util.DoubleDouble} values
	 */
	public static final double EPS = 1.23259516440783e-32; /* = 2^-106 */

	/**
	 * Converts the string argument to a util.DoubleDouble number.
	 * 
	 * @param str
	...
	/**
	 * Converts the <tt>double</tt> argument to a util.DoubleDouble number.
	 * 
	 * @param x
	 *            a numeric value
	 * @return the extended precision version of the value
	...
	/**
	 * Creates a new util.DoubleDouble with value 0.0.
	 */
	public DoubleDouble() {
		init(0.0);
	}
	...
	/**
	 * Creates a new util.DoubleDouble with value x.
	 * 
	 * @param x
	...
	/**
	 * Creates a new util.DoubleDouble with value (hi, lo).
	 * 
	 * @param hi
	...
	/**
	 * Creates a new util.DoubleDouble with value equal to the argument.
	 * 
	 * @param dd
	 *            the value to initialize
	 */
	...
	/**
	 * Returns a util.DoubleDouble whose value is <tt>(this + y)</tt>.
	 * 
	 * @param y
	 *            the addend
	 * @return <tt>(this + y)</tt>
	...
	/*
	 * // experimental private util.DoubleDouble selfAdd(double yhi, double ylo) {
	...
	/*
	 * public util.DoubleDouble selfSubtract(util.DoubleDouble y) { if (isNaN()) return
	 * this; return selfAdd(-y.hi, -y.lo); }
	 */

	/**
	 * Returns a util.DoubleDouble whose value is <tt>-this</tt>.
	 * 
	 * @return <tt>-this</tt>
	 */
	 ...
	 * 
	 * @param y
	 *            a util.DoubleDouble value to multiply by
	 * @return this
	 */
	...
	/*
	 * 
	 * // experimental public util.DoubleDouble selfDivide(util.DoubleDouble y) { double
	...
	/**
	 * Returns a util.DoubleDouble whose value is <tt>1 / this</tt>.
	 * 
	...
	/**
	 * Tests whether this value is equal to another <tt>util.DoubleDouble</tt> value.
	 * 
	 * @param y
	 *            a util.DoubleDouble value
	...
	/**
	 * Tests whether this value is greater than another <tt>util.DoubleDouble</tt>
	 * value.
	 * 
	 * @param y
	 *            a util.DoubleDouble value
	...
	/**
	 * Tests whether this value is less than another <tt>util.DoubleDouble</tt>
	 * value.
	 * 
	 * @param y
	 *            a util.DoubleDouble value
	...
	/**
	 * Compares two util.DoubleDouble objects numerically.
	 * 
	...
	/**
	 * Converts a string representation of a real number into a util.DoubleDouble
